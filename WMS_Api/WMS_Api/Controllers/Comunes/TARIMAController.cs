...
namespace WMS_Api.Controllers.Comunes
{
    ...
    {
        TARIMAProceso bll = new TARIMAProceso();

        /// <summary>
        /// Funcion que devuelve el listado
        /// </summary>
        /// <returns>Devuelve un IEnumerable<VIEW_TARIMA></returns>
        [HttpGet]
        public IEnumerable<VIEW_TARIMA> Get()
        {
            var returnValue = (IEnumerable<VIEW_TARIMA>)bll.Obtener(null).Respuesta;
            return returnValue;
        }
        ...
        ///// <returns>Devuelve un IEnumerable<VIEW_TARIMA></returns>
        ////[HttpGet]
        ////public IEnumerable<VIEW_TARIMA> Get(string id)
        ////{
        ////    var returnValue = (IEnumerable<VIEW_TARIMA>)bll.ValidarTARIMA(null, GlobalesLibrary.OPERACION_CONSULTAR, 0, new VIEW_TARIMA { TARIMA_ID = id }).Respuesta;
        ////    return returnValue;
        ////}
        ...
        //{
        //    var returnValue = bll.ProcesoTARIMA(GlobalesLibrary.OPERACION_AGREGAR, new VIEW_TARIMA { TARIMA_ID = id, USUARIO_ALTA_ID = Convert.ToDecimal(usuario_alta_id), FECHA_ALTA = Convert.ToDateTime(fecha_alta) }).Respuesta;
        ...
        //{
        //    var returnValue = bll.ProcesoTARIMA(GlobalesLibrary.OPERACION_MODIFICAR, new VIEW_TARIMA { TARIMA_ID = id, USUARIO_MODIFICA_ID = Convert.ToDecimal(usuario_modifica_id), FECHA_MODIFICA = Convert.ToDateTime(fecha_modifica) }).Respuesta;
        ...
        //{
        //    var returnValue = bll.ProcesoTARIMA(GlobalesLibrary.OPERACION_ELIMINAR, new VIEW_TARIMA { TARIMA_ID = id, USUARIO_ELIMINA_ID = Convert.ToDecimal(usuario_elimina_id), FECHA_ELIMINA = Convert.ToDateTime(fecha_elimina) }).Respuesta;
